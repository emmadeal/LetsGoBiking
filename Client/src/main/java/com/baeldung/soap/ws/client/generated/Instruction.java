...
/**
 * <p>Classe Java pour Instruction complex type.
 * 
...
public class Instruction {
    ...
    @XmlElementRef(name = "text", namespace = "http://schemas.datacontract.org/2004/07/RootingService", type = JAXBElement.class, required = false)
